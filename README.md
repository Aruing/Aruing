...
Not yet built (planned 0.1.4/0.2+): session listing command, streaming responses, write tools with approval, multi-cluster, Web UI, npm distribution. See [`docs/project-state.md`](docs/project-state.md) for the live roadmap.
